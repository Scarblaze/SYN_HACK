                ...
                <div className="bg-white/90 shadow-2xl rounded-3xl p-8 md:p-12 border border-indigo-100">
                    ...
                    {isSubmitted ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-gray-700 font-semibold mb-1 text-base"> Hostel <span className="text-red-500">*</span></label>
                                    {user?.role === "student" ? (
                                        <input
                                            type="text"
                                            value={user.branch}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-gray-700 font-semibold mb-1 text-base"> Room Number <span className="text-red-500">*</span></label>
                                    <input
                                        type="text"
                                        name="inchargeName"
                                        onChange={handleChange}
