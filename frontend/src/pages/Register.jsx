                    ...
                    >
                        <div className="text-center space-y-6">
                            ...
                            <p className="text-lg text-white/90">
                                Join <span className="font-bold text-yellow-200">VNIT College</span> and resolve your queries easily.
                            </p>
                            <Link
                                to="/login"
                                ...
                                {({ isSubmitting, values }) => (
                                    <Form className="space-y-6">
                                        ...
                                        >
                                            <div className="flex-1">
                                                ...
                                                >
                                                    ...
                                                    <option value="resolver">Worker</option>
                                                </Field>
                                        ...
                                        >
                                            {values.role === "admin" ? (
                                                <div className="flex-1">
                                                    <label className="block text-xs font-semibold text-gray-700 mb-1"> Hostel <span className="text-red-500">*</span></label>
                                                    <input
                                                        type="text"
                                                        name="branch"
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <Field
                                                        ...
                                                        className="w-full border border-indigo-200 px-3 py-2 rounded bg-white text-gray-900 focus:ring-2 focus:ring-indigo-400 text-sm"
                                                    >
                                                        <option value="">Select Hostel (if student)</option>
